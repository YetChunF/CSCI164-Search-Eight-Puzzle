...
def main():
    ...
    # InitialState = [] #Take in 8 data 
    # InitialState.append(str(data[0]))
    # InitialState.append(str(data[1]))
    # InitialState.append(str(data[2]))
    # InitialState.append(str(data[3]))
    # InitialState.append(str(data[4]))
    # InitialState.append(str(data[5]))
    # InitialState.append(str(data[6]))
    # InitialState.append(str(data[7]))
    # InitialState.append(str(data[8]))
    ...
    if(function == "lbfs"):
        ...
        lbfsNode = BFS.GoalNode
        lbfsMoves = []

        while InitialStateLong != lbfsNode.state:
            if lbfsNode.move == 1:
                path = 'U'
            if lbfsNode.move == 2:
                path = 'D'
            ...
            if lbfsNode.move == 4:
                path = 'R'
            lbfsMoves.insert(0, path)
            lbfsNode = lbfsNode.parent

        #Print results
        print("Path: ", lbfsMoves)
        print("Cost: ", len(lbfsMoves))
        print("Nodes expanded: ", BFS.numberOfPaths)
